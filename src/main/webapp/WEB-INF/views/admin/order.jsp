        ...
        <div class="row justify-content-center ">
            <div class="col-sm-5 mr-3">
                <div class="card" style="border: rgb(205, 218, 27) 1px solid ;box-shadow: 3px 3px 3px rgb(229, 241, 157);">
                    <div class="card-header text-center" style="background-color: rgb(52,58,64);">
                        <div class="row justify-content-center">
                            <h3 class="card-title" style="color: rgb(241, 234, 226); font-size: 25px; font-weight: bold;">ORDER LIST</h3>
                        </div>
                    </div>
                    <table class="table table-hover table-bordered  mb-0">
                        ...
                        <body>
                        	<c:forEach var="item" items="${page.content}">
                                ...
                                <td style="vertical-align: middle;">${item.account.name}</td>
                                <td style="vertical-align: middle;">${item.address}</td>						          
                                <td style="vertical-align: middle;"><fmt:formatDate  pattern="dd-MM-yyyy" value="${item.createdate}" /> </td>
                                <td style="vertical-align: middle;"><a href="admin/order/${item.id }"> <span class="fa fa-edit" style="color: brown;font-size: 19px;"></span></a></td>
                            	</tr>
                        	</c:forEach>                 
                        </body>
                    </table>
                        ...
                        <div class="row justify-content-center">
                            <div class="text-center">
                                <ul class="pagination mb-1"
                                        ...
                                        <li class="page-item mr-2 ${page.number == 0?'disabled':'' }"><a  href="admin/order?p=0"
                                            class="page-link btn btn-light"><span
                                                class="fa fa-angle-double-left	"
                                                style="color: rgb(52,58,64); font-size: 20px;"></span></a></li>
                                        <li class="page-item mr-2   ${page.number == 0?'disabled':'' }"><a href="admin/order?p=${page.number-1 }"
                                            class="page-link btn btn-light"><span
                                        ...
                                        <li class="page-item mr-2 ${page.number == (page.totalPages-1)?'disabled':'' }"><a   href="admin/order?p=${page.number+1 }"
                                            class="btn page-link btn-light"><span
                                                class="fa fa-angle-right"
                                                style="color: rgb(52,58,64); font-size: 20px;"></span></a></li>
                                        <li class="page-item mr-2 ${page.number == (page.totalPages-1)?'disabled':'' }"><a  href="admin/order?p=${page.totalPages-1 }"
                                            class="btn page-link btn-light"><span
            ...
            <div class="col-sm-6">
              <div class="card" style="border: rgb(205, 218, 27) 1px solid ;box-shadow: 3px 3px 3px rgb(229, 241, 157);">
                <div class="card-header text-center" style="background-color: rgb(52,58,64);">
                    <div class="row justify-content-center">
                        <h3 class="card-title" style="color: rgb(241, 234, 226); font-size: 25px; font-weight: bold;">ORDER DETAIL : ${id}</h3>
                    </div>
                </div>
                <table class="table table-hover table-bordered  mb-0">
                    <thead>
                        ...
                        <tr>
                          <td >
                            <div style="width: 100%; overflow: hidden; height: 60px;">
                                <img src="/images/phukien/${item.product.image}" width="100%" alt="">
                            </div>
                        </td>
                            <td style="vertical-align: middle;">${item.product.name}</td>
                            <td style="vertical-align: middle;"><fmt:formatNumber type="number" pattern="###,###,###" value="${item.price}" /></td>
                            <td style="vertical-align: middle;">${item.quantity}</td>
                            <td style="vertical-align: middle;"><fmt:formatNumber type="number" pattern="###,###,###" value="${item.price * item.quantity}" /></td>							          
                          </tr>
                      </c:forEach>                 
                    </body>
                </table>
                <div class="card-footer">
                    <div class="row justify-content-end">
                      <h3 class="card-title" style="color: rgb(37, 33, 28); font-size: 20px;">
                        Tổng Tiền : <b><fmt:formatNumber type="number" pattern="###,###,###,###" value="${totalPrice}" /></b> VND </h3>
                    </div>
                </div>
            </div>
            </div>
