			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="xeoxo/login" method="post">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form:form action="xeoxo/signup" modelAttribute="account"  method="post">
							...
							<div class="form-group">
								<form:input path="email" class="form-control"  placeholder="Email" type="mail"/>
